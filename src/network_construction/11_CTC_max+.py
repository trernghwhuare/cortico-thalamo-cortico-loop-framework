...
import logging
import glob
detailed_cell_files = glob.glob("*.cell.nml")
...
# %%
clusters, pt_cells = cluster_pt_cells.get_pt_clusters()
...
Continuous_Projections = [
    ...
    (CTs_cSTUT, ITs + CTs, "AMPA_NMDA",Syn_AMPA.id,Syn_NMDA.id),
    (CTs_bSTUT + CTs_dSTUT, ITs + CTs, "GABA",Syn_GABAa.id,Syn_GABAb.id),
    (CTs_cSTUT, TCs_intralaminar + TCs_matrix,"AMPA_NMDA",Syn_AMPA.id,Syn_NMDA.id),
    (CTs_bSTUT + CTs_dSTUT, TCs_intralaminar + TCs_matrix,"GABA",Syn_GABAa.id,Syn_GABAb.id),
    (TCs_matrix,ITs + TCs_intralaminar + TCs_matrix + PTs,"AMPA_NMDA",Syn_AMPA.id,Syn_NMDA.id),
    (TCs_intralaminar, TCs_matrix, "GABA",Syn_GABAa.id,Syn_GABAb.id),
    (TCs_intralaminar, TCs_core, "GABA",Syn_GABAa.id,Syn_GABAb.id),
    (TCs_core, ITs + TCs_intralaminar + TCs_core + PTs + ITs ,"GABA", Syn_GABAa.id,Syn_GABAb.id)
]
...
InputLists=[
    ...
    (TCs_intralaminar + TCs_core,'inh_PG',"GABA"),
...
nml_file = f"{net.id}.net.nml"
result = optimized_write_and_validate(nml_doc, nml_file)
