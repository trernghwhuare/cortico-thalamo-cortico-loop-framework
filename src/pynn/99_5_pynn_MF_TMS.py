    ...
    def objective(param_vector):
        ...
        try:
            ...
            if options.benchmark == "COBA":
                ...
                target_inh_rate = 16.5  # COBA should have ~6.5 Hz
            else:  # CUBA
                target_exc_rate = 6.0   # CUBA should have ~6 Hz  
                target_inh_rate = 3.0   # CUBA should have ~3 Hz
...
filename = normalized_filename("PyNN_TMS_results", "%s_%s_exc" % (net_id, options.benchmark), "pkl",
                               options.simulator)
