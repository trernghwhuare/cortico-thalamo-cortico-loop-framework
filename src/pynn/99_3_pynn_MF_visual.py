    ...
    def objective(param_vector):
        ...
        try:
            ...
            if options.benchmark == "COBA":
                ...
                target_inh_rate = 0.0   # COBA should have ~0 Hz
            else:  # CUBA
                target_exc_rate = 6.0   # CUBA should have ~6 Hz  
                target_inh_rate = 0.0   # CUBA should have ~0 Hz
...
filename = normalized_filename("PyNN_visual_results", "%s_%s_exc" % (net_id, options.benchmark), "pkl",
                               options.simulator)
