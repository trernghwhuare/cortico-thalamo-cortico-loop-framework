TITLE Mod file for component: Component(id=input_0_49999999999999994nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_49999999999999994nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.5 (nA)                   : was: 4.999999999999999E-10 (current)
}
