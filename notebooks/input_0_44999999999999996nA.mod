TITLE Mod file for component: Component(id=input_0_44999999999999996nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_44999999999999996nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.45 (nA)                  : was: 4.5E-10 (current)
}
