TITLE Mod file for component: Component(id=input_0_9000000000000002nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_9000000000000002nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.9 (nA)                   : was: 9.000000000000003E-10 (current)
}
