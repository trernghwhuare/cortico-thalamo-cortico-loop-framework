TITLE Mod file for component: Component(id=input_0_9500000000000003nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_9500000000000003nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.95 (nA)                  : was: 9.500000000000004E-10 (current)
}
