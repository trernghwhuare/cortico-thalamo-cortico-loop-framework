TITLE Mod file for component: Component(id=input_0_7000000000000001nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_7000000000000001nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.7 (nA)                   : was: 7.000000000000001E-10 (current)
}
