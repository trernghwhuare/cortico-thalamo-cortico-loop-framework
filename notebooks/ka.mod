...
NEURON {
    ...
    RANGE gion
    RANGE i__ka : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_steadyState_midpoint = -60 (mV)      : was: -0.06 (voltage)
    m_steadyState_scale = 8.5 (mV)         : was: 0.0085 (voltage)
...
BREAKPOINT {
    ...
    ik = gion * (v - ek)
    i__ka =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!
