...
PARAMETER {
    ...
    m_forwardRate_rate = 1.6 (kHz)         : was: 1600.0 (per_time)
    m_forwardRate_midpoint = 5 (mV)        : was: 0.005 (voltage)
    m_forwardRate_scale = 13.888889 (mV)   : was: 0.013888889000000001 (voltage)
    m_reverseRate_rate = 0.1 (kHz)         : was: 100.0 (per_time)
    m_reverseRate_midpoint = -8.9 (mV)     : was: -0.0089 (voltage)
