...
NEURON {
    ...
    RANGE gion
    RANGE i__cat_a : a copy of the variable for current which makes it easier to access from outside the mod file
...
BREAKPOINT {
    ...
    ica = gion * (v - eca)
    i__cat_a =  -1 * ica : set this variable to the current also - note -1 as channel current convention for LEMS used!
