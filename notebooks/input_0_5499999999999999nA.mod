TITLE Mod file for component: Component(id=input_0_5499999999999999nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_5499999999999999nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.55 (nA)                  : was: 5.5E-10 (current)
}
