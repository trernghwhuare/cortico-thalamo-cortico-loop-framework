...
NEURON {
    ...
    RANGE gion
    RANGE i__km : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    q10ConductanceScaling_q10Factor = 2.3  : was: 2.3 (none)
    q10ConductanceScaling_experimentalTemp = 296.15 (K): was: 296.15 (temperature)
    q10ConductanceScaling_TENDEGREES = 10 (K): was: 10.0 (temperature)
    n_instances = 1                        : was: 1.0 (none)
    n_forwardRate_rate = 0.009000001 (kHz) : was: 9.0 (per_time)
    n_forwardRate_midpoint = -30 (mV)      : was: -0.03 (voltage)
    n_forwardRate_scale = 9 (mV)           : was: 0.009000000000000001 (voltage)
    n_reverseRate_rate = 0.009000001 (kHz) : was: 9.0 (per_time)
    n_reverseRate_midpoint = -30 (mV)      : was: -0.03 (voltage)
    n_reverseRate_scale = -9 (mV)          : was: -0.009000000000000001 (voltage)
    n_q10Settings_q10Factor = 2.3          : was: 2.3 (none)
    n_q10Settings_experimentalTemp = 296.15 (K): was: 296.15 (temperature)
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=km type=ionChannelHH), from conductanceScaling; Component(id=null type=q10ConductanceScaling)
    ...
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=km type=ionChannelHH), from gates; Component(id=n type=gateHHrates)
    ...
    ik = gion * (v - ek)
    i__km =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!
