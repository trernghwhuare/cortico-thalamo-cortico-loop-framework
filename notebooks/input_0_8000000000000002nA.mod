TITLE Mod file for component: Component(id=input_0_8000000000000002nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_8000000000000002nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.8 (nA)                   : was: 8.000000000000002E-10 (current)
}
