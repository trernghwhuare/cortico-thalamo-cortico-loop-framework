TITLE Mod file for component: Component(id=input_0_8500000000000002nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_8500000000000002nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.85 (nA)                  : was: 8.500000000000003E-10 (current)
}
