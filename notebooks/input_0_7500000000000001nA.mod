TITLE Mod file for component: Component(id=input_0_7500000000000001nA type=pulseGenerator)
...
NEURON {
    POINT_PROCESS input_0_7500000000000001nA
    ELECTRODE_CURRENT i
...
PARAMETER {
    ...
    amplitude = 0.75 (nA)                  : was: 7.500000000000002E-10 (current)
}
