...
NEURON {
    ...
    RANGE gion
    RANGE i__kdr_fs : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_steadyState_midpoint = -27 (mV)      : was: -0.027 (voltage)
    m_steadyState_scale = 11.5 (mV)        : was: 0.0115 (voltage)
}
...
BREAKPOINT {
    ...
    ik = gion * (v - ek)
    i__kdr_fs =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!
