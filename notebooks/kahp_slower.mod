...
NEURON {
    ...
    RANGE gion
    RANGE i__kahp_slower : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_forwardRate_CONC_SCALE = 1000000 (mM): was: 1000000.0 (concentration)
    m_reverseRate_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    m_reverseRate_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
    m_reverseRate_CONC_SCALE = 1000000 (mM): was: 1000000.0 (concentration)
}
...
BREAKPOINT {
    ...
    ik = gion * (v - ek)
    i__kahp_slower =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!
